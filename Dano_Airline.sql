...
FROM 
    ...
    ORDER BY Avg_Service_Value ASC ;
...
-- Using the temp_table, calculate the occurrence (sum and %) of each scale value (0-5) for each service
SELECT 
    service,
...
-- FIND OUT THE CONTRIBUTION OF EACH CUSTOMER SEGMENT TO THE ALL SERVICES(FROM AVERAGE) REPRESENTED ON THE LIKERT SCALE    
-- customer type
